...
|Користувач|
    start
    :Користувач натискає на кнопку звернення до системи;
|Система|
    :Система надає користувачу форму для заповнення;
|Користувач|
    :Користувач отримує доступ для заповнення форми;
    :Користувач вписує текст свого питання;
    :Користувач надсилає заповнену форму системі;
|Система|
    :Система аналізує проблему користувача за ключовими словами;
        note right #ffaaaa
    ...
    :Система надсилає користувачу необхідну довідку;
|Користувач|
    :Користувач отримує довідку та закінчує взаємодію;
    stop;
@enduml
